...
| [Bash tool](#anthropic-bash-tool) | Execute Claude's native bash tool with local command execution |
| [Text editor](#anthropic-text-editor) | Provide Claude's text editor tool for file editing |
| [Memory](#anthropic-memory) | Provide Claude's memory tool for persistent agent memory |
| [File search](#anthropic-file-search) | Search tools for state-based file systems |
...
| Middleware | Description |
|------------|-------------|
| [Content moderation](#openai-content-moderation) | Moderate agent traffic using OpenAI's moderation endpoint |
